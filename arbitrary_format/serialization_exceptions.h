...
using errinfo_description = boost::error_info<struct tag_description, const char*>;
using errinfo_requested_this_many_bytes_more = boost::error_info<struct tag_requested_this_many_bytes_more, uintmax_t>;
